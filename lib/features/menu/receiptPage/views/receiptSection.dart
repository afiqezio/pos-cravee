      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            // Logo Section
            Center(
                child: SvgPicture.asset('assets/svg/pretzley.svg', height: 36)),
            ...
            Row(
              ...
              children: [
                Text('Order Number',
                    style:
                        AppTexts.regular(size: 12, color: AppColors.greyText)),
                Text('#0009010',
                    style:
                        AppTexts.regular(size: 12, color: AppColors.greyText)),
              ],
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                ...
                                style: AppTexts.regular(size: 14)),
                            Text('-RM0.00', style: AppTexts.regular(size: 14)),
                            Text(
                ...
                Row(
                  ...
                  children: [
                    Text(
                      'Total Points',
                      style:
                          AppTexts.medium(color: AppColors.secondary, size: 14),
                    ),
                    Text(
                      '1014 pts',
                      style:
